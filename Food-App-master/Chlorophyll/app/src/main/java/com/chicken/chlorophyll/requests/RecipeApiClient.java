...
import com.chicken.chlorophyll.AppExecuters;
...
public class RecipeApiClient {
    ...
    private MutableLiveData<Boolean> mIsRecipeRequestTimedOut=new MutableLiveData<>();
    ...
    public LiveData<Boolean> isRecipeRequestTimedOut(){
        return mIsRecipeRequestTimedOut;
    }
    ...
    public void searchRecipebyId(String recipeId){
        ...
        mIsRecipeRequestTimedOut.setValue(false);
        AppExecuters.getInstance().NetworkIO().schedule(new Runnable() {
            @Override
            public void run() {
                //Let the user know its timed out
                mIsRecipeRequestTimedOut.postValue(true);
                handler.cancel(true);
    ...
    private class RetrieveRecipesRunnable implements Runnable{
        ...
        private Call<RecipeSearchResponse> getRecipes(String query,int pageNumber){
            return ServiceGenerator.getRecipeApi().searchResponse(
                    Constants.API_KEY,
                    query,
